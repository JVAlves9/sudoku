...
class Ui_initialWindow(QtWidgets.QWidget):
    ...
    def __init__(self, Dialog,MainWindow):
        ...
        self.name_label.setGeometry(QtCore.QRect(80, 10, 120, 20))
        font = QtGui.QFont()
        ...
        self.lineEdit.setGeometry(QtCore.QRect(10, 40, 271, 21))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.name_label.setText(_translate("Dialog", "Player name:"))
